...
- **AI 属性明确**：Claude Coral 作为 AI 专属强调色，与主操作色分层
...
| 文件                                                       | 内容                                                                                                           |
| ---------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- |
| [colors.md](./colors.md)                                   | 品牌色、ConfigProvider token、Claude Coral 决策与约束                                                          |
| [typography.md](./typography.md)                           | 页面标题、内容标题、卡片标题、正文与辅助说明的文本角色规则；工作台 vs 公共入口两套页面上下文；Sidecar 密度例外 |
| [page-header.md](./page-header.md)                         | 公共页面头部组件规则：标题语义、图标对齐、aside 边界、状态控件落位                                             |
| [spacing.md](./spacing.md)                                 | 页面、区块、卡片、表单、弹层、空状态的边距节奏规则                                                             |
| [table-rules.md](./table-rules.md)                         | 业务表格规范：信息结构、列宽、密度、状态、操作、空态与可读性约束                                               |
...
| [chart.md](./chart.md)                                     | 图表与 dashboard 规范：问题定义、口径、时间窗、复核、导出与解释性要求                                          |
...
| [interaction-feedback.md](./interaction-feedback.md)       | 交互反馈规则：hover、active、焦点环、过渡动画、视觉分隔策略、低噪音状态信号                                    |
