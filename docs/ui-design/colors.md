...
- Deep Blue 是主交互色，不是大面积涂抹色；它更适合按钮、链接、焦点和少量关键操作
- Sky Cyan 是提示性的点，不是铺陈性的面；它应像火花或外壳信号，而不是持续铺满整个界面
- Signal Red 只用于错误、风险、阻断，不参与品牌氛围营造
- 一个界面若同时高频出现深蓝、青、红，通常已经过响；此时应先减少颜色种类，而不是继续补中间色
- 真正耐看的界面通常让大多数面积退回中性色，把品牌色留给最值得被看见的那一处
