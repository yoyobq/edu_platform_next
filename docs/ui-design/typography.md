...
- 先用标题位置、分组、间距、对齐和留白建立层级
- 若结构已经清楚，不要再用额外 icon、分隔线、底纹、角标去重复表达同一个层级
- 如果一个标题必须靠图标、标签或强调色才能成立，通常应先回头检查版式结构
- 留白通常比额外的装饰元素更稳定，也更耐看
...
- 页面头若已经有标题、副标题和操作区，不要再额外补一排无强语义的装饰 icon
...
- 不要在一张卡片内堆两层 `Title`
- 若卡片头已经有清楚标题，不要再为了“显得完整”补无必要的 leading icon
