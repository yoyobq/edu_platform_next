...
- `labs`：`/labs/change-login-email`、`/labs/invite-issuer`、`/labs/upstream-session-demo`、`/labs/integrated-plan-corrections`、`/labs/academic-timetable`、`/labs/academic-workload`、`/labs/staff-semester-profiles`
