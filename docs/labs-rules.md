...
- `/labs/my-teaching-plan`
  ...
  - 授课方式、逐课次地点例外、F“授课章节与内容”和 G“课外作业”按当前账号、目标教师、学期、课程在当前浏览器保留至最后编辑后 24 小时；统一授课地点不属于限时草稿
  - 页面每次读取当前真源重新生成 A–C；F/G 可手工编辑，也可在 upstream 登录后从近 6 学期的同教师相似课程中选择一条历史计划，按课次顺序只补空白项
  - 历史计划与当前计划行数不一致时只对应双方共有的前缀行；历史参考不落库、不覆盖已有 F/G 编辑，也不建立跨学期 Course 身份
  - Excel 是用户长期保留完整逐课次教学计划的唯一载体，页面必须持续强提示本地草稿边界并提供直接导出入口
